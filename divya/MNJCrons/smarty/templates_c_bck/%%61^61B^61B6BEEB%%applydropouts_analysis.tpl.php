<?php /* Smarty version 2.6.19, created on 2016-01-18 12:38:40
         compiled from /usr/local/apache/htdocs/smarty/templates/dashboard/applydropouts_analysis.tpl */ ?>
<html>
<title>--- APPLY DROP OUTS ANALYSIS ---</title>
<script type="text/javascript">
</script>

<body>

<h3>     ...APPLY DROP OUTS ANALYSIS..... </h3>
<form name="form1" action="applydropouts_analysis.php" method="">
...
<select name="year" id="year">
			...
			<option <?php if ($this->_tpl_vars['sel_year'] == '2012'): ?>selected='true'<?php endif; ?>>2012
			<option <?php if ($this->_tpl_vars['sel_year'] == '2013'): ?>selected='true'<?php endif; ?>>2013
			<option <?php if ($this->_tpl_vars['sel_year'] == '2014'): ?>selected='true'<?php endif; ?>>2014
			<option <?php if ($this->_tpl_vars['sel_year'] == '2015'): ?>selected='true'<?php endif; ?>>2015
			<option <?php if ($this->_tpl_vars['sel_year'] == '2016'): ?>selected='true'<?php endif; ?>>2016
...
<div align="center">Apply Dropout Data for  Date <?php echo $this->_tpl_vars['DATE']; ?>
</div>
<table border=1 align="center">
<tr width="100%">
</tr>
 <?php $_from = $this->_tpl_vars['DISPLAY_ARR']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['index'] => $this->_tpl_vars['label']):
?>
   <tr><td><?php echo $this->_tpl_vars['index']; ?>
</td><td><?php echo $this->_tpl_vars['label']['LABEL']; ?>
</td><td><?php echo $this->_tpl_vars['label']['COUNT']; ?>
</td></tr>
