<?php /* Smarty version 2.6.19, created on 2015-09-04 16:39:27
         compiled from /usr/local/apache/htdocs/smarty/templates/mailers//ftd/ftdrecruiter_contact.tpl */ ?>
<?php if ($this->_tpl_vars['PROFILE_FLAG'] != 'f'): ?>
...
/AL/ValidateEmail/alid/<?php echo $this->_tpl_vars['ALID2']; ?>
/email/<?php echo $this->_tpl_vars['EMAIL_MD']; ?>
" target="_blank" style="text-decoration:none; color:#1e82c1; font-size:11px;">Verify now</a></td>
        </tr>
      </table>
      <?php endif; ?> </td>
    <td width="10"></td>
...
/AL/ValidateEmail/alid/<?php echo $this->_tpl_vars['ALID4']; ?>
/email/<?php echo $this->_tpl_vars['EMAIL_MD']; ?>
/<?php echo $this->_tpl_vars['GAPARAM']; ?>
" target="_blank" style="text-decoration:none; color:#1e82c1; font-size:12px;">Login to your profile</a></td>
  </tr>
</table>
<?php endif; ?>