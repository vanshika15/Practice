<?php /* Smarty version 2.6.19, created on 2015-01-05 15:40:17
	...
	<TR>
      ...
      <TD>From Date :-&nbsp;&nbsp;&nbsp;&nbsp;
        ...
        <select name="YYYY">
          ...
          <option value="2012" <?php if ($this->_tpl_vars['YYYY'] == 2012): ?> selected <?php endif; ?>>2012</option>
          <option value="2013" <?php if ($this->_tpl_vars['YYYY'] == 2013): ?> selected <?php endif; ?>>2013</option>
          <option value="2014" <?php if ($this->_tpl_vars['YYYY'] == 2014): ?> selected <?php endif; ?>>2014</option>
          <option value="2015" <?php if ($this->_tpl_vars['YYYY'] == 2015): ?> selected <?php endif; ?>>2015</option>
      ...
      <TD>To Date :-&nbsp;&nbsp;&nbsp;&nbsp;
        ...
        <select name="YYYY2">
          ...
          <option value="2012" <?php if ($this->_tpl_vars['YYYY2'] == 2012): ?> selected <?php endif; ?>>2012</option>
          <option value="2013" <?php if ($this->_tpl_vars['YYYY2'] == 2013): ?> selected <?php endif; ?>>2013</option>
          <option value="2014" <?php if ($this->_tpl_vars['YYYY2'] == 2014): ?> selected <?php endif; ?>>2014</option>
          <option value="2015" <?php if ($this->_tpl_vars['YYYY2'] == 2015): ?> selected <?php endif; ?>>2015</option>
