<?php /* Smarty version 2.6.19, created on 2014-07-02 09:27:35
         compiled from /usr/local/apache/htdocs/smarty/templates/mailers/mailer_revamp/Update_PremiumGoogle.tpl */ ?>
<html>
<head>
...
<script type="application/ld+json">
{
  ...
  "action": {
    "@type": "ViewAction",
    "name": "Update Now",
    "url": "<?php echo $this->_tpl_vars['arrPaths']['URL']; ?>
/AL/jamxUpdate?alid=<?php echo $this->_tpl_vars['ALID']; ?>
&<?php echo $this->_tpl_vars['GAPARAM']; ?>
&utm_content=updateprofilelink"
  },
  "description": "This emailer is sent to registered users informing them about their profile being outdated. This direct call to action takes the users to their respective registered accounts for further actions."
}
</script>
</head>
<body>
