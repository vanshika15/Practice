<?php /* Smarty version 2.6.19, created on 2014-06-10 11:41:37
         compiled from /usr/local/apache/htdocs/smarty/templates/dashboard/dashboard_mobilemis.tpl */ ?>
<html>
<head>
<title>
  Mobile MIS
...
<body>
<form name="formmain" action="dashboard_mobile.php" method="post">
...
<?php else: ?>
Please enter valid dates and then click submit.
<?php endif; ?>
<br>
<br>
<br>
...
<tr>
        <td colspan=1></td>
        <td colspan=2 class=mytext1><li><a href="http://lfvsfcp10127.dn.net/dashboard/MIS/mobileLogCount.php">WAP site / Blackberry App Report</a></li></td>
</tr>

<tr> 
        <td colspan=1></td>
        <td colspan=2 class=mytext1><li><a href="http://lfvsfcp10127.dn.net/dashboard/dashboard_mobile_applyerror.php">Mobile Apply Error Report</a></li></td>
</tr>
<tr> 
        <td colspan=1></td>
        <td colspan=2 class=mytext1><li><a href="http://lfvsfcp10127.dn.net/dashboard/dashboard_mobile_nonverifiedmobile.php">Non Verified Mobile Number</a></li></td>
</tr>
</table>
