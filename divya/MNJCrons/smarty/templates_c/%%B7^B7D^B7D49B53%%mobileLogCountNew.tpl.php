<?php /* Smarty version 2.6.19, created on 2017-01-11 20:34:26
         compiled from /usr/local/apache/htdocs/smarty/templates/dashboard/mobileLogCountNew.tpl */ ?>
<html>
<head>
...
<BODY>
<h1>Mobile Naukri Log Details <?php echo $this->_tpl_vars['CLIENT']; ?>
</h1>
<a href="mobileLogOrigCount.php?type=4">Click here to view Mobile Site source wise Breakup</a>
<br/>
<br />
...
<Input type = 'Radio' Name ='type' value= 2>I-Phone
<Input type = 'Radio' Name ='type' value= 3>Andriod
<Input type = 'Radio' Name ='type' value= 4>HTML -5
<Input type = 'Radio' Name ='type' value= 5>Nk-Test
<Input type = 'Radio' Name ='type' value= 6>Olive pad
<Input type = 'Radio' Name ='type' value= 7>I-Phone API
<Input type = 'Radio' Name ='type' value= 8>Android API
<Input type = 'Radio' Name ='type' value= 9>Window API
<Input type = 'Radio' Name ='type' value= 10>HTML5-MODS
<Input type = 'Radio' Name ='type' value= 11>ANDROID-APP MODS
<Input type = 'Radio' Name ='type' value= 12>IOS-APP MODS
</p>
...
<?php else: ?>
	...
	<th>Blank ID</th>
        <th>Invalid ID</th>
	<th>Logged-in CTCSearch</th>
        <th>Not Logged-in CTCSearch</th>
	<th>Logged-in Relevant Search</th>
        <th>Not Logged-in Relevant Search</th>
	</tr>
...
?>
	        <tr>
                ...
                <td> <?php if ($this->_tpl_vars['LOGGEDCTC'][$this->_sections['i']['index']]): ?> <?php echo $this->_tpl_vars['LOGGEDCTC'][$this->_sections['i']['index']]; ?>
 <?php else: ?> 0 <?php endif; ?></td>
                <td> <?php if ($this->_tpl_vars['NOTLOGGEDCTC'][$this->_sections['i']['index']]): ?> <?php echo $this->_tpl_vars['NOTLOGGEDCTC'][$this->_sections['i']['index']]; ?>
 <?php else: ?> 0 <?php endif; ?></td>
                <td> <?php if ($this->_tpl_vars['LOGGEDINRELSRCH'][$this->_sections['i']['index']]): ?> <?php echo $this->_tpl_vars['LOGGEDINRELSRCH'][$this->_sections['i']['index']]; ?>
 <?php else: ?> 0 <?php endif; ?></td>
                <td> <?php if ($this->_tpl_vars['NOTLOGGEDINRELSRCH'][$this->_sections['i']['index']]): ?> <?php echo $this->_tpl_vars['NOTLOGGEDINRELSRCH'][$this->_sections['i']['index']]; ?>
 <?php else: ?> 0 <?php endif; ?></td>
        	</tr>	  
	<?php endfor; endif; ?>
<?php endif; ?>
