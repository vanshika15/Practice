<?php /* Smarty version 2.6.18, created on 2016-11-18 13:42:56
         compiled from /usr/local/apache/htdocs/smarty/templates/ud/ud_logDet.tpl */ ?>
<html>
<head>
...
<body>
<form method="post" name="loginDetForm" action="ud_logDet.php">
...
$this->_sections['i']['loop'] = Smarty::is_array($_loop=$this->_tpl_vars['arrUser_log']) ? count($_loop) : max(0, (int)$_loop); unset($_loop);
