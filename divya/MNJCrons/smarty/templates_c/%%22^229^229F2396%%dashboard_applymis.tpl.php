<?php /* Smarty version 2.6.19, created on 2017-01-16 16:37:45
...
">
		...
		<option value="2016" <?php if ($this->_tpl_vars['startyear'] == 2016): ?> selected <?php endif; ?>>2016</option>
		<option value="2017" <?php if ($this->_tpl_vars['startyear'] == 2017): ?> selected <?php endif; ?>>2017</option>
		<option value="2018" <?php if ($this->_tpl_vars['startyear'] == 2018): ?> selected <?php endif; ?>>2018</option>
		<option value="2019" <?php if ($this->_tpl_vars['startyear'] == 2019): ?> selected <?php endif; ?>>2019</option>
        </select>
        </font></b></TD>
      <TD width="46"> 
...
">
		...
		<option value="2014" <?php if ($this->_tpl_vars['endyear'] == 2014): ?> selected <?php endif; ?>>2014</option>
                ...
                <option value="2016" <?php if ($this->_tpl_vars['endyear'] == 2016): ?> selected <?php endif; ?>>2016</option>
                <option value="2017" <?php if ($this->_tpl_vars['endyear'] == 2017): ?> selected <?php endif; ?>>2017</option>
                <option value="2018" <?php if ($this->_tpl_vars['endyear'] == 2018): ?> selected <?php endif; ?>>2018</option>
                <option value="2019" <?php if ($this->_tpl_vars['endyear'] == 2019): ?> selected <?php endif; ?>>2019</option>
        </select>
        </font></b></TD>
    </TR>
