<?php /* Smarty version 2.6.19, created on 2019-01-28 11:37:35
         compiled from /usr/local/apache/htdocs/delAcc/tpl/deleteAccount.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'count', '/usr/local/apache/htdocs/delAcc/tpl/deleteAccount.tpl', 32, false),)), $this); ?>
<html>
<head>
...
<form method="post" action="email.php" onsubmit="return validateActionForm()">
    <input type="hidden" name="NAME" value="<?php echo $this->_tpl_vars['arrUserDetails'][0]['NAME']; ?>
" />
    <input type="hidden" name="RESID" value="<?php echo $this->_tpl_vars['arrUserDetails'][0]['RESID']; ?>
" />
    <input type="hidden" name="USERID" value="<?php echo $this->_tpl_vars['arrUserDetails'][0]['USERID']; ?>
" />
    <input type="hidden" name="MOD_DT" value="<?php echo $this->_tpl_vars['arrUserDetails'][0]['MOD_DT']; ?>
" />
    <input type="hidden" name="GENDER" value="<?php echo $this->_tpl_vars['arrUserDetails'][0]['GENDER']; ?>
" />
    <input type="hidden" name="EMAIL" value="<?php echo $this->_tpl_vars['Email']; ?>
" />
    <input type="submit" name="REPLY" value="REPLY WITH YOUR RESUME">
</form>
