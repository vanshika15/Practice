<?php /* Smarty version 2.6.19, created on 2017-06-23 17:31:04
         compiled from /usr/local/apache/htdocs/smarty/templates/mailers/mailer_revamp/cam_np1Staging.tpl */ ?>
<html>
<head>
...
&src=M&orig=cam" target="_blank" style="color:#1e82c1; font-size:13px; text-decoration:none;">Verify Now</a></td>
                <td></td>
              </tr>
<?php endif; ?>
...
<?php endif; ?>
<?php if ($this->_tpl_vars['experienceNotValid'] || $this->_tpl_vars['eduexpnotspecified'] || $this->_tpl_vars['compdetailnotspecified']): ?>
<?php if ($this->_tpl_vars['counter']++): ?> <?php endif; ?>
              <tr>
                <td height="30"></td>
...
unset($_smarty_tpl_vars);
 ?>
	<?php endif; ?>
        <tr>
          <td height="105"></td>
          <td width="499">We wish you good luck in your Job search<br/><br/>Thanks &amp; Regards,<br/>
