<?php /* Smarty version 2.6.19, created on 2017-06-24 16:30:21
         compiled from /usr/local/apache/htdocs/smarty/templates/mailers/mailer_revamp/cam_rp3.tpl */ ?>
<html>
<head>
...
<table border="0" cellspacing="0" cellpadding="0" align="center" style="max-width:600px; min-width:320px; border:1px solid #e9e9e9;-webkit-text-size-adjust: 100%;">
  ...
  <tr>
    <td width="13"></td>
    <td width="598"><a href="http://www.naukri.com/premium.php" target="_blank"><img src="<?php echo $this->_tpl_vars['arrPaths']['IMGURL']; ?>
 ...
 ?>
        ...
        <tr>
          ...
          <td width="499">We wish you good luck in your Job search<br/>
            Cheers,<br/>
            <br>
            <a href="http://www.naukri.com/premium/" target="_blank"><img src="<?php echo $this->_tpl_vars['arrPaths']['IMGURL']; ?>
