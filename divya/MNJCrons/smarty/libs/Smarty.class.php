...
class Smarty
{
     ...
     * @var string
     */
    var $template_dir    =  '/usr/local/apache/htdocs/smarty/templates';
     ...
     * @var string
     */
    var $compile_dir     =  '/usr/local/apache/htdocs/smarty/templates_c';
     ...
     * @var string
     */
    var $config_dir      =  '/usr/local/apache/htdocs/smarty/configs';
