<?php /* Smarty version 2.6.19, created on 2012-08-13 15:15:28
...
<form name="formmain" id="formmain" method = "post" action = "">
...
><?php echo $this->_tpl_vars['TO_YEAR_ARR'][$this->_sections['i']['index']]['label']; ?>
  ...
  <div id="fornouse"></div>
	<h3 style="font-size:16px;"><center><font color="RED"><i> <?php echo $this->_tpl_vars['ErrorMsg']; ?>
</i></font></center></h3>
</form>	
</body>
</html>