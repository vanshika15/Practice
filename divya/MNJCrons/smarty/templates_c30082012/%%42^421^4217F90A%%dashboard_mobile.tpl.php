<?php /* Smarty version 2.6.19, created on 2012-08-13 19:40:54
  ...
  <body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0">
    ...
    <TABLE WIDTH = "90%" BORDER = "1" ALIGN = "CENTER" BORDERCOLOR = "#CCCCFF">
      ...
      <TR>
        ...
        <TD ROWSPAN = "2" WIDTH = "7%" ALIGN = "CENTER"><b><font face="Verdana, Arial, Helvetica, sans-serif" size="2"> JD Page Views Total</b></FONT></TD>
        <TD COLSPAN = "2" WIDTH = "7%" ALIGN = "CENTER"><b><font face="Verdana, Arial, Helvetica, sans-serif" size="2"> JD Page Views</b></FONT></TD>
        ...
        <TD COLSPAN = "2" WIDTH = "40%" ALIGN = "CENTER"><b><font face="Verdana, Arial, Helvetica, sans-serif" size="2"> Email Clicks</b></FONT></TD>
        <TD COLSPAN = "2" WIDTH = "40%" ALIGN = "CENTER"><b><font face="Verdana, Arial, Helvetica, sans-serif" size="2"> Email Sent</b></FONT></TD>
        <TD ROWSPAN = "2" WIDTH = "40%" ALIGN = "CENTER"><b><font face="Verdana, Arial, Helvetica, sans-serif" size="2"> View Job Clicks</b></FONT></TD>
      </TR>
      <TR>
        ...
        <TD WIDTH = "4%" ALIGN = "CENTER"><b><font face="Verdana, Arial, Helvetica, sans-serif" size="2"> Webjobs</b></FONT></TD>
        <TD WIDTH = "4%" ALIGN = "CENTER"><b><font face="Verdana, Arial, Helvetica, sans-serif" size="2"> Postedjobs</b></FONT></TD>
...
?>
        <TR>
            <TD WIDTH = "5%" ALIGN = "CENTER"><?php echo $this->_tpl_vars['details']; ?>
</TD>
...
<?php else: ?>&nbsp;<?php endif; ?></TD>
 ...
 <?php else: ?>&nbsp;<?php endif; ?></TD>
            <TD WIDTH = "5%" ALIGN = "CENTER"><?php if ($this->_tpl_vars['MOBILE_DETAILS'][$this->_tpl_vars['details']]['dmsPageViewsWebjobs']): ?> <?php echo $this->_tpl_vars['MOBILE_DETAILS'][$this->_tpl_vars['details']]['dmsPageViewsWebjobs']; ?>
 <?php else: ?>&nbsp;<?php endif; ?></TD>
            <TD WIDTH = "5%" ALIGN = "CENTER"><?php if ($this->_tpl_vars['MOBILE_DETAILS'][$this->_tpl_vars['details']]['dmsPageViewsPostedjobs']): ?> <?php echo $this->_tpl_vars['MOBILE_DETAILS'][$this->_tpl_vars['details']]['dmsPageViewsPostedjobs']; ?>
 <?php else: ?>&nbsp;<?php endif; ?></TD>
            <TD WIDTH = "5%" ALIGN = "CENTER"><?php if ($this->_tpl_vars['MOBILE_DETAILS'][$this->_tpl_vars['details']]['applyTotal']): ?> <?php echo $this->_tpl_vars['MOBILE_DETAILS'][$this->_tpl_vars['details']]['applyTotal']; ?>
 <?php else: ?>&nbsp;<?php endif; ?></TD>
            <TD WIDTH = "5%" ALIGN = "CENTER"><?php if ($this->_tpl_vars['MOBILE_DETAILS'][$this->_tpl_vars['details']]['applyUniqueUsers']): ?> <?php echo $this->_tpl_vars['MOBILE_DETAILS'][$this->_tpl_vars['details']]['applyUniqueUsers']; ?>
 <?php else: ?>&nbsp;<?php endif; ?></TD>
            <TD WIDTH = "5%" ALIGN = "CENTER"><?php if ($this->_tpl_vars['MOBILE_DETAILS'][$this->_tpl_vars['details']]['applyMobRec']): ?> <?php echo $this->_tpl_vars['MOBILE_DETAILS'][$this->_tpl_vars['details']]['applyMobRec']; ?>
 <?php else: ?>&nbsp;<?php endif; ?></TD>
            <TD WIDTH = "5%" ALIGN = "CENTER"><?php if ($this->_tpl_vars['MOBILE_DETAILS'][$this->_tpl_vars['details']]['mnjViewHits']): ?> <?php echo $this->_tpl_vars['MOBILE_DETAILS'][$this->_tpl_vars['details']]['mnjViewHits']; ?>
 <?php else: ?>&nbsp;<?php endif; ?></TD>
 ...
 <?php else: ?>&nbsp;<?php endif; ?></TD>
            <TD WIDTH = "5%" ALIGN = "CENTER"><?php if ($this->_tpl_vars['MOBILE_DETAILS'][$this->_tpl_vars['details']]['dmclWhoViewCv']): ?> <?php echo $this->_tpl_vars['MOBILE_DETAILS'][$this->_tpl_vars['details']]['dmclWhoViewCv']; ?>
 <?php else: ?>&nbsp;<?php endif; ?></TD>
            <TD WIDTH = "5%" ALIGN = "CENTER"><?php if ($this->_tpl_vars['MOBILE_DETAILS'][$this->_tpl_vars['details']]['dmclLogins']): ?> <?php echo $this->_tpl_vars['MOBILE_DETAILS'][$this->_tpl_vars['details']]['dmclLogins']; ?>
 <?php else: ?>&nbsp;<?php endif; ?></TD>       
             <TD WIDTH = "5%" ALIGN = "CENTER"><?php if ($this->_tpl_vars['MOBILE_DETAILS'][$this->_tpl_vars['details']]['wjWebJobsEmailClicksMobile']): ?> <?php echo $this->_tpl_vars['MOBILE_DETAILS'][$this->_tpl_vars['details']]['wjWebJobsEmailClicksMobile']; ?>
 <?php else: ?>&nbsp;<?php endif; ?></TD>
             <TD WIDTH = "5%" ALIGN = "CENTER"><?php if ($this->_tpl_vars['MOBILE_DETAILS'][$this->_tpl_vars['details']]['wjPostedJobsEmailClicksMobile']): ?> <?php echo $this->_tpl_vars['MOBILE_DETAILS'][$this->_tpl_vars['details']]['wjPostedJobsEmailClicksMobile']; ?>
 <?php else: ?>&nbsp;<?php endif; ?></TD>
             <TD WIDTH = "5%" ALIGN = "CENTER"><?php if ($this->_tpl_vars['MOBILE_DETAILS'][$this->_tpl_vars['details']]['wjWebJobsEmailSentMobile']): ?> <?php echo $this->_tpl_vars['MOBILE_DETAILS'][$this->_tpl_vars['details']]['wjWebJobsEmailSentMobile']; ?>
 <?php else: ?>&nbsp;<?php endif; ?></TD>
             <TD WIDTH = "5%" ALIGN = "CENTER"><?php if ($this->_tpl_vars['MOBILE_DETAILS'][$this->_tpl_vars['details']]['wjPostedJobsEmailSentMobile']): ?> <?php echo $this->_tpl_vars['MOBILE_DETAILS'][$this->_tpl_vars['details']]['wjPostedJobsEmailSentMobile']; ?>
 <?php else: ?>&nbsp;<?php endif; ?></TD>
             <TD WIDTH = "5%" ALIGN = "CENTER"><?php if ($this->_tpl_vars['MOBILE_DETAILS'][$this->_tpl_vars['details']]['wjAppliesMobile']): ?> <?php echo $this->_tpl_vars['MOBILE_DETAILS'][$this->_tpl_vars['details']]['wjAppliesMobile']; ?>
 <?php else: ?>&nbsp;<?php endif; ?></TD>
