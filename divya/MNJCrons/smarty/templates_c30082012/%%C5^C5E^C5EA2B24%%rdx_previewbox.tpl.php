<?php /* Smarty version 2.6.19, created on 2012-08-14 13:48:37
...
<div align="center">
	<div class="folwid" style="text-align: left;">	
	  ...
	  <tr>
		 <td width="378">&nbsp;</td>
		 <td width="399"><img src="http://static.naukimg.com/ni/nistatic/niresdex/gifs/new1.gif" width="28" height="16"></td>
	  </tr>
   </table>
...
<?php if ($this->_tpl_vars['RESUME_ARR']['ALTEMAIL'] != ""): ?>
<span class="reskey">Alt Email</span><span class="reskey1">: <?php echo $this->_tpl_vars['RESUME_ARR']['ALTEMAIL']; ?>
</span><br><?php endif; ?>
...
<div class="sp2"><br></div>
	...
	<table width="777" border="0" cellspacing="0" cellpadding="0" align="center">
	  <tr>
		 <td width="378">&nbsp;</td>
		 <td width="399" align="left"><img src="http://static.naukimg.com/ni/nistatic/niresdex/gifs/new1.gif" width="28" height="16"></td>
	  </tr>
   </table>
<table style="border-collapse: collapse;" align="center" border="1" bordercolor="#a7d8f8" cellpadding="0" cellspacing="0" height="28" width="777">
	<tbody><tr>
