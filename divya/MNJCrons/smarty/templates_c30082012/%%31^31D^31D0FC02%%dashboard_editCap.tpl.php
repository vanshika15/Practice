<?php /* Smarty version 2.6.19, created on 2012-08-24 15:53:44
...
' name='DailyLt' id='DailyLt' ></TD>
         <TD><input type="textarea" value='<?php echo $this->_tpl_vars['CLIENT_INFO'][0]['clWeekLt']; ?>
' name='WeekLt' id='WeekLt' ></TD>
         <TD><input type="textarea" value='<?php echo $this->_tpl_vars['CLIENT_INFO'][0]['clMonthLt']; ?>
' name='MonthLt' id='MonthLt'></TD>
         <TD><input type="textarea" maxlength='300' value='' name='reason' id='reason'></TD>
       </tr>
