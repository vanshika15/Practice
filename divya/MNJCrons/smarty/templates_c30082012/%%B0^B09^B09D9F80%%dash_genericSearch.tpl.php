<?php /* Smarty version 2.6.19, created on 2012-08-13 15:49:11
         compiled from ni/nidashboard/dash_genericSearch.tpl */ ?>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/strict.dtd">
<html>
<head>
<title>Client / Company Search - Compnay MIS</title>
<style>	
	.style1
	{
		font-weight:bold;
	...
	.gobutton{color:#ffffff;background-color:#0E5BA8;font-weight:bold;CURSOR:hand;width:60px;margin-top:1px;margin-bottom:1px;}
</style>
</head>
<body>
...
<!-- No Action should be defined as it is generic-->
...
" <?php endif; ?> size=40></TD></TR>
	    <TR><TD ALIGN = "CENTER" colspan="2"><input type="submit" name="btnSearch" value="Search" class="gobutton"></TD></TR>
	  </table>
</form>
<br/>
...
?>
		<tr> 
			<td width="25%" align="center"><a href="?action=<?php echo $this->_tpl_vars['ACTION']; ?>
&clientid=<?php echo $this->_tpl_vars['COMPINFO_ARR'][$this->_sections['name']['index']]['clientId']; ?>
&compid=<?php echo $this->_tpl_vars['COMPINFO_ARR'][$this->_sections['name']['index']]['compId']; ?>
" target="_blank" title="click here"><?php echo $this->_tpl_vars['COMPINFO_ARR'][$this->_sections['name']['index']]['compName']; ?>
</a></td>
			<td width="20%" align="center"><?php echo $this->_tpl_vars['COMPINFO_ARR'][$this->_sections['name']['index']]['compMasterEmail']; ?>
</td>
			<td width="20%" align="center"><?php echo $this->_tpl_vars['COMPINFO_ARR'][$this->_sections['name']['index']]['clientUsername']; ?>
</td>
...
<?php else: ?>
	<div style="color:red;text-align:center;"><?php echo $this->_tpl_vars['ERROR_MSG']; ?>
</div>
<?php endif; ?>
<br />
</body>
