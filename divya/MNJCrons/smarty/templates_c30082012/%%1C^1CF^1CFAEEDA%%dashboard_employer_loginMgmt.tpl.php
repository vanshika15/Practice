<?php /* Smarty version 2.6.19, created on 2012-08-14 10:40:22
         compiled from ni/nidashboard/dashboard_employer_loginMgmt.tpl */ ?>
...
<?php if ($this->_tpl_vars['countrow'] != 0): ?>
	<table width="95%" border="1" align="center" bordercolor="#EEEEEE">
		<tr> 
			...
			<td width="10%" align="center" class="style1">Logins</td>
		</tr>
...
?>
		<tr> 
			<td width="25%" align="center"><a href="dashboard_employer_loginMgmt.php?action=generate&compId=<?php echo $this->_tpl_vars['COMPINFO_ARR'][$this->_sections['name']['index']]['compId']; ?>
&name=<?php echo $this->_tpl_vars['COMPINFO_ARR'][$this->_sections['name']['index']]['compName']; ?>
&clientId=<?php echo $this->_tpl_vars['COMPINFO_ARR'][$this->_sections['name']['index']]['clientId']; ?>
&section=<?php echo $this->_tpl_vars['SECTION']; ?>
" target="_blank" title="click here to see count of job posted & applies"><?php echo $this->_tpl_vars['COMPINFO_ARR'][$this->_sections['name']['index']]['compName']; ?>
</a></td>
			<td width="20%" align="center"><?php echo $this->_tpl_vars['COMPINFO_ARR'][$this->_sections['name']['index']]['compMasterEmail']; ?>
</td>
			<td width="20%" align="center"><a href="dashboard_clientinfo.php?uname=<?php echo $this->_tpl_vars['COMPINFO_ARR'][$this->_sections['name']['index']]['clientUsername']; ?>
&section=PASSWORD" target="_blank" title="click here to see the password"><?php echo $this->_tpl_vars['COMPINFO_ARR'][$this->_sections['name']['index']]['clientUsername']; ?>
</a></td>
