<?php /* Smarty version 2.6.19, created on 2011-11-26 12:00:56
         compiled from ni/nidashboard/dashboard_cron_resume_update_mailer1.tpl */ ?>
...
/updatemailer1/img1.jpg" alt="" width="172" height="68" border="0" /></td>
<td width="193">&nbsp;</td>
<td valign="bottom"><a href="http://www.naukrigulf.com" target="_blank"><img src="<?php echo $this->_tpl_vars['MANAGER_IMAGES_PATH']; ?>
/updatemailer1/naukrigulf_logo.gif" alt="" width="200" height="54" border="0" /></a></td>
</tr>
<tr>
<td bgcolor="#2783C6"><img src="<?php echo $this->_tpl_vars['MANAGER_IMAGES_PATH']; ?>
/updatemailer1/img2.jpg" width="172" height="91" border="0" /></td>
...
" target="_blank" style="color:#FFFFFF; text-decoration:none;"><div align="left" style="font:normal 40px Tahoma; color:#FFFFFF; line-height:40px; padding-left:10px;">
Want the Job?<br /></div>
...
/updatemailer1/leftbg.gif" width="14">&nbsp;</td>
<td>
...
<p>Recruiters are constantly on a lookout for the right candidate. And it could be you! <br />
  All you need to do is update your CV. You are missing out as  recruiters prefer to access an updated CV. </p>
  <p>Opportunities galore just a step away. So, go right ahead and be noticed.<br />
  You last updated your CV on  <strong><?php echo $this->_tpl_vars['MOD_DATE_STR']; ?>
</strong></p>

To bag the best of the jobs on offer, please update the following:
  </div>
 </td>
</tr>
<tr>
...
<tr>
<td width="25%" height="25" style="font:normal 11px Verdana; padding-top:3px;  padding-bottom:3px;"><strong>Current Location </strong></td>
<td width="2%" style="font:normal 11px Verdana;">:</td>
...
<td background="<?php echo $this->_tpl_vars['MANAGER_IMAGES_PATH']; ?>
/updatemailer1/rightbg.gif" width="16">&nbsp;</td>
</tr>
</table>
...
/updatemailer1/btm.gif" alt="" width="600" height="25" /></td>
</tr>
</table>
</body>
</html>
