<?php /* Smarty version 2.6.19, created on 2011-11-25 19:45:53
...
$this->_sections['i']['loop'] = is_array($_loop=$this->_tpl_vars['MAILERFLAG']) ? count($_loop) : max(0, (int)$_loop); unset($_loop);
