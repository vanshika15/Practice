<?php /* Smarty version 2.6.19, created on 2012-02-01 17:20:48
         compiled from ni/nidashboard/dashboard_cron_resume_update_mailer5.tpl */ ?>
...
/updatemailer5/alert1.jpg" alt="" width="209" height="68" border="0" /></td>
<td width="193">&nbsp;</td>
<td valign="bottom"><a href="http://www.naukrigulf.com" target="_blank"><img src="<?php echo $this->_tpl_vars['MANAGER_IMAGES_PATH']; ?>
/updatemailer5/naukrigulf_logo.gif" alt="" width="200" height="54" border="0" /></a></td>
</tr>
<tr>
<td bgcolor="#2783C6"><img src="<?php echo $this->_tpl_vars['MANAGER_IMAGES_PATH']; ?>
/updatemailer5/alert2.jpg" alt="" width="209" height="112" border="0" /></td>
...
<div align="right" style="font:normal 28px Tahoma; color:#FFFFFF; line-height:31px; padding-right:10px;">
Make best use of what
Naukrigulf.com has to offer<br />
</div>
<div align="right" style="font:normal 20px Tahoma; color:#FFFFFF;  padding-right:10px;">Update your CV Now</div>
</a></td>
</tr>
</table>
<table width="600" border="0" cellpadding="0" cellspacing="0"  align="center" >
...
/updatemailer5/leftbg.gif" width="14">&nbsp;</td>
<td>
...
<div style="font:normal 11px Verdana; padding-top:9px; padding-left:7px; padding-bottom:8px; line-height:18px;">
 ...
 <p>It has been more than one year since you last updated your CV. As a result, your CV is currently not 
  being accessed by the recruiters. </p>

 <p>It is recommended that you update your CV. This will help you make use of resources on
  offer at <a href="http://www.naukrigulf.com" target="_blank">Naukrigulf.com</a>. With a large database of live  jobs and a pool of recruiters, finding that perfect job is never too
  difficult.</p>
...
<td background="<?php echo $this->_tpl_vars['MANAGER_IMAGES_PATH']; ?>
/updatemailer5/rightbg.gif" width="16">&nbsp;</td>
</tr>
...
/updatemailer5/btm.gif" alt="" width="600" height="25" /></td>
</tr>
</table>
</body>
</html>