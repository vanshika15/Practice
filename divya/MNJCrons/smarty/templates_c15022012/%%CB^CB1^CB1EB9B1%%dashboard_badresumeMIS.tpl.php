<?php /* Smarty version 2.6.19, created on 2012-01-23 15:15:45
         compiled from ni/nidashboard/dashboard_badresumeMIS.tpl */ ?>
<html>
...
<table width="95%" border="1" align="center" bordercolor="#CCCCFF">
 ...
 <td width="12%"><b><font face="Verdana, Arial, Helvetica, sans-serif" size="2"><center>Date(Y-M-D)</center></font></b></td>

 <td width="8%"><b><font face="Verdana, Arial, Helvetica, sans-serif" size="2"><center> Verified Count</center></font></b></td>
 
 <td width="8%"><b><font face="Verdana, Arial, Helvetica, sans-serif" size="2"><center> Deleted Count</center></font></b></td>
 
 <td width="8%"><b><font face="Verdana, Arial, Helvetica, sans-serif" size="2"><center> Bad Resume Count</center></font></b></td>
...
?>
<?php echo '<tr><td><font face="Verdana, Arial, Helvetica, sans-serif" size="2"><center>'; ?><?php echo $this->_tpl_vars['INFO_ARR'][$this->_sections['mysec']['index']]['date']; ?><?php echo '</center></font></td><td><font face="Verdana, Arial, Helvetica, sans-serif" size="2"><center>'; ?><?php echo $this->_tpl_vars['INFO_ARR'][$this->_sections['mysec']['index']]['verifiedCount']; ?><?php echo '</center></font></td><td><font face="Verdana, Arial, Helvetica, sans-serif" size="2"><center>'; ?><?php echo $this->_tpl_vars['INFO_ARR'][$this->_sections['mysec']['index']]['deletedCount']; ?><?php echo '</center></font></td><td><font face="Verdana, Arial, Helvetica, sans-serif" size="2"><center>'; ?><?php echo $this->_tpl_vars['INFO_ARR'][$this->_sections['mysec']['index']]['badresumeCount']; ?><?php echo '</center></font></td></tr>'; ?>
