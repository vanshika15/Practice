<?php /* Smarty version 2.6.19, created on 2008-06-25 10:22:27
...
<?php if ($this->_tpl_vars['FLAG'] == 'true'): ?>
 ...
 <table border="1">
 <tr><th>S.no:</th><th>Username</th><th>Password</th></tr>
 <?php unset($this->_sections['i']);
$this->_sections['i']['name'] = 'i';
$this->_sections['i']['loop'] = is_array($_loop=$this->_tpl_vars['sm_row']) ? count($_loop) : max(0, (int)$_loop); unset($_loop);
