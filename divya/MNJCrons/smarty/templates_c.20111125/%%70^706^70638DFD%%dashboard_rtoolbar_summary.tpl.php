<?php /* Smarty version 2.6.19, created on 2011-05-18 10:01:01
         compiled from ni/nidashboard/dashboard_rtoolbar_summary.tpl */ ?>
<html>
<head>
<script>
...
<form name="formmain" method = "post" onsubmit = "openNewWindow('dashboard_rtoolbar_summary.php?action=overview')" action ="dashboard_rtoolbar_summary.php">
...
<table width="70%" border="1" align="center" bordercolor="#CCCCFF">
 ...
 <td width="46%"><b><font face="Verdana, Arial, Helvetica, sans-serif" size="2">Find Date : </font></b></td>
  ...
  size="2">&nbsp;<b><?php echo $this->_tpl_vars['ARR_DATA']['logdate']; ?>
</b></font></td>
 </tr>
  <tr> 
    <td width="46%"><b><font face="Verdana, Arial, Helvetica, sans-serif"
    size="2"> RCS pop up shown </font></b></td>
    <td width="54%"><font face="Verdana, Arial, Helvetica, sans-serif"
    size="2">&nbsp;<?php echo $this->_tpl_vars['ARR_DATA']['popupshown']; ?>
</font></td>
  </tr>
   <tr>
      <td width="46%"><b><font face="Verdana, Arial, Helvetica, sans-serif"
      size="2">Clicks on RCS pop up</font></b></td>
      <td width="54%"><font face="Verdana, Arial, Helvetica, sans-serif"
      size="2">&nbsp;<?php echo $this->_tpl_vars['ARR_DATA']['popupclicks']; ?>
</font></td>
  </tr>
  <tr> 
    <td width="46%"><b><font face="Verdana, Arial, Helvetica, sans-serif"
    size="2">Unique clicks on Collapse Button (Recruiter Toolbar)</font></b></td>
    <td width="54%"><font face="Verdana, Arial, Helvetica, sans-serif"
    size="2">&nbsp;<?php echo $this->_tpl_vars['ARR_DATA']['tlbrcollpsclicks']; ?>
</font></td>
  </tr>
  <td width="46%"><b><font face="Verdana, Arial, Helvetica, sans-serif"
  size="2">RCS link shown</font></b></td>
      <td width="54%"><font face="Verdana, Arial, Helvetica, sans-serif"
      size="2">&nbsp;<?php echo $this->_tpl_vars['ARR_DATA']['explinkshown']; ?>
</font></td>
        </tr>

 <tr>
    <td width="46%"><b><font face="Verdana, Arial, Helvetica, sans-serif"
    size="2">Clicks on RCS link (Expanded)</font></b></td>
    <td width="54%"><font face="Verdana, Arial, Helvetica, sans-serif"
    size="2">&nbsp;<?php echo $this->_tpl_vars['ARR_DATA']['explinkclicks']; ?>
</font></td>
  </tr>
 <tr>
    <td width="46%"><b><font face="Verdana, Arial, Helvetica, sans-serif"
    size="2">Clicks on RCS link (Collapsed)</font></b></td>
    <td width="54%"><font face="Verdana, Arial, Helvetica, sans-serif"
    size="2">&nbsp;<?php echo $this->_tpl_vars['ARR_DATA']['collpslinkclicks']; ?>
</font></td>
  </tr>
 <tr>
    <td width="46%"><b><font face="Verdana, Arial, Helvetica, sans-serif"
    size="2">Do not show pop-ups</font></b></td>
    <td width="54%"><font face="Verdana, Arial, Helvetica, sans-serif"
    size="2">&nbsp;<?php echo $this->_tpl_vars['ARR_DATA']['donotshow']; ?>
</font></td>
  </tr>
  <tr><td><b><font face="Verdana, Arial, Helvetica, sans-serif" size="2">Jobs
  Posted</font></b></td><td><font face="Verdana, Arial, Helvetica, sans-serif"
      size="2">&nbsp;<?php echo $this->_tpl_vars['ARR_DATA']['jobsposted']; ?>
</font></td> </tr>
  </tr>
</table>
<br />
