<?php /* Smarty version 2.6.19, created on 2008-06-28 17:10:18
         compiled from ni/nidashboard/dashboard_productdistro.tpl */ ?>
<html>
	<head>
		<SCRIPT LANGUAGE="JavaScript">
			function dashboard_showMessage()
			{
				if(document.getElementById("id_groupby").selectedIndex == 1 )
				{
					document.getElementById("id_saletype").selectedIndex = 0;
					return confirm("For Geographical Breakup Sale Type is taken as Full/Credit/Part");
				}
			}
		</SCRIPT>
	</head>
...
<form name="productdistro" method="post" action="<?php echo $this->_tpl_vars['FORM_ACTION']; ?>
" onsubmit=" return dashboard_showMessage();">
...
><?php echo $this->_tpl_vars['TO_YEAR_ARR'][$this->_sections['i']['index']]['label']; ?>
    ...
    <TR>
    	<TD align="right"><b>Sale Type</b></TD>
    	<TD align="right">
    		 <select name="saletype" id="id_saletype">
        		<?php unset($this->_sections['i']);
$this->_sections['i']['name'] = 'i';
$this->_sections['i']['loop'] = is_array($_loop=$this->_tpl_vars['SALETYPE']) ? count($_loop) : max(0, (int)$_loop); unset($_loop);
$this->_sections['i']['show'] = true;
$this->_sections['i']['max'] = $this->_sections['i']['loop'];
$this->_sections['i']['step'] = 1;
$this->_sections['i']['start'] = $this->_sections['i']['step'] > 0 ? 0 : $this->_sections['i']['loop']-1;
...
$this->_sections['i']['last']       = ($this->_sections['i']['iteration'] == $this->_sections['i']['total']);
?>
        			<option value="<?php echo $this->_tpl_vars['SALETYPE'][$this->_sections['i']['index']]['value']; ?>
" <?php echo $this->_tpl_vars['SALETYPE'][$this->_sections['i']['index']]['selected']; ?>
><?php echo $this->_tpl_vars['SALETYPE'][$this->_sections['i']['index']]['label']; ?>
</option>
         		<?php endfor; endif; ?>
        	</select>
    	</TD>
	...
	<TR>
    	...
    	<TD align="right">
    		 <select name="groupby" id="id_groupby" title="For Geographical Breakup Sale Type is taken as Full/Credit/Part">
        		<?php unset($this->_sections['i']);
$this->_sections['i']['name'] = 'i';
$this->_sections['i']['loop'] = is_array($_loop=$this->_tpl_vars['GROUPBY']) ? count($_loop) : max(0, (int)$_loop); unset($_loop);
$this->_sections['i']['show'] = true;
$this->_sections['i']['max'] = $this->_sections['i']['loop'];
$this->_sections['i']['step'] = 1;
$this->_sections['i']['start'] = $this->_sections['i']['step'] > 0 ? 0 : $this->_sections['i']['loop']-1;
...
$this->_sections['i']['last']       = ($this->_sections['i']['iteration'] == $this->_sections['i']['total']);
?>
        			<option value="<?php echo $this->_tpl_vars['GROUPBY'][$this->_sections['i']['index']]['value']; ?>
" <?php echo $this->_tpl_vars['GROUPBY'][$this->_sections['i']['index']]['selected']; ?>
><?php echo $this->_tpl_vars['GROUPBY'][$this->_sections['i']['index']]['label']; ?>
</option>
         		<?php endfor; endif; ?>
        	</select>
    	</TD>
