<?php /* Smarty version 2.6.19, created on 2008-07-04 15:44:11
         compiled from ni/nidashboard/je_jobsqueue.tpl */ ?>
<html>
<head>
<script>
...
<table width="777" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#66CCFF">
  <tr> 
    <td width="552"> 
      <div align="left"><font face="Verdana, Arial, Helvetica, sans-serif" size="5"><b><font color="#66CCFF">JOB EDIT</font>         :: Total Jobs That came  </b></font></div>
    </td>
    <td width="225"> 
...
<form name="formmain" method = "post" onsubmit = "openNewWindow('je_jobsqueue.php?action=overview')" action = "je_jobsqueue.php">
