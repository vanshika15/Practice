<?php /* Smarty version 2.6.19, created on 2008-08-25 12:21:54
         compiled from ./dashboard/rahul_dashboard_cron_updatemailer1.tpl */ ?>
...
/topmailer1.jpg" width="600" height="68"></td>
<!--<td valign="bottom"><img src="<?php echo $this->_tpl_vars['Images_Path']; ?>
/img1.jpg" alt="" width="172" height="68" border="0"/></td>
<td width="193">&nbsp;</td>
...
/img2.jpg" width="172" height="91" border="0"/></td>
...
" style="color:#FFFFFF; text-decoration:none;" target="_blank"><div align="left" style="font:normal 40px Tahoma; color:#FFFFFF; line-height:40px; padding-left:10px;"><font color="#FFFFFF">
Want the Job?</font><br /></div>
...
<p>Recruiters are constantly on a lookout for the right candidate. And it could be you! <br />
  All you need to do is to update your resume. You are missing out as updated resumes are<br />
  what the recruiters access. </p>
...
To bag the best out of the jobs on offer, please update the following:
  </div>
 </td>
</tr>
<tr>
