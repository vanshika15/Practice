<?php /* Smarty version 2.6.19, created on 2011-02-16 15:37:19
         compiled from ni/nidashboard/dashboard_response_toggle.tpl */ ?>
<html>
<br />
...
<tr>
 <td><b><font face="Verdana, Arial, Helvetica, sans-serif" size="2"><center>Click Date</center></font></b></td>
 <td><b><font face="Verdana, Arial, Helvetica, sans-serif" size="2"><center>Toggle to OLD Count</center></font></b></td>
 <td><b><font face="Verdana, Arial, Helvetica, sans-serif" size="2"><center>Toggle to New Count</center></font></b></td>
 <td><b><font face="Verdana, Arial, Helvetica, sans-serif" size="2"><center>Toggle Total Count</center></font></b></td>
</tr>
...
<tr>
   ...
   <td><font face="Verdana, Arial, Helvetica, sans-serif" size="2"><center><?php if ($this->_tpl_vars['data']['rtOldToggleCount']): ?> <?php echo $this->_tpl_vars['data']['rtOldToggleCount']; ?>
 <?php else: ?> 0 <?php endif; ?></center></font></td>
   <td><font face="Verdana, Arial, Helvetica, sans-serif" size="2"><center><?php if ($this->_tpl_vars['data']['rtNewToggleCount']): ?> <?php echo $this->_tpl_vars['data']['rtNewToggleCount']; ?>
 <?php else: ?> 0 <?php endif; ?></center></font></td>
   <td><font face="Verdana, Arial, Helvetica, sans-serif" size="2"><center><?php if ($this->_tpl_vars['data']['rtTotalCount']): ?> <?php echo $this->_tpl_vars['data']['rtTotalCount']; ?>
 <?php else: ?> 0 <?php endif; ?></center></font></td>
</tr>
