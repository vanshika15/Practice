<?php /* Smarty version 2.6.19, created on 2009-02-20 12:59:11
         compiled from ni/nidashboard/clientservicingmis.tpl */ ?>
<html>
<head>
	<script>
...
<?php echo $this->_tpl_vars['DASHBOARD_HEADER']; ?>
    ...
    <br><br>
<form name='form1' method='post' action="clientservicingmis.php" onsubmit="return validateSaveRemarks();">
<?php if ($this->_tpl_vars['CLIENT_DETAILS_ARR']): ?>
<table border="2">
	<tr align='center' bgcolor="#00BFFF"><td colspan='26'><b>Date &nbsp; &nbsp;<?php echo $this->_tpl_vars['displayDate']; ?>
</b></td></tr>
	<tr bgcolor="#00BFFF">
...
" SIZE=10 disabled=true></td>
	  ...
	  <td align="center"><?php echo $this->_tpl_vars['CLIENT_DETAILS_ARR'][$this->_tpl_vars['details']]['companytype']; ?>
</td>
