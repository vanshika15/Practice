<?php /* Smarty version 2.6.19, created on 2011-09-02 11:21:10
         compiled from /usr/local/apache/htdocs/smarty/templates/dashboard/mini_dashboard_vikas.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'math', '/usr/local/apache/htdocs/smarty/templates/dashboard/mini_dashboard_vikas.tpl', 80, false),)), $this); ?>
<html>
<head>
...
<tr>
    ...
    <td><font face="Verdana, Arial, Helvetica, sans-serif" size="2"><?php echo $this->_tpl_vars['lg_apply_confirmationLSI']; ?>
</font></td>
    <td><font face="Verdana, Arial, Helvetica, sans-serif" size="2"><?php echo $this->_tpl_vars['nl_apply_confirmationLSI']; ?>
</font></td>
    <td><font face="Verdana, Arial, Helvetica, sans-serif" size="2"><?php echo smarty_function_math(array('equation' => "x + y",'x' => $this->_tpl_vars['lg_apply_confirmationLSI'],'y' => $this->_tpl_vars['nl_apply_confirmationLSI']), $this);?>
</font></td>
    <td><font face="Verdana, Arial, Helvetica, sans-serif" size="2"><?php echo $this->_tpl_vars['lg_apply_confirmationLSI_jd']; ?>
</font></td>
    <td><font face="Verdana, Arial, Helvetica, sans-serif" size="2"><?php echo $this->_tpl_vars['nl_apply_confirmationLSI_jd']; ?>
</font></td>
    <td><font face="Verdana, Arial, Helvetica, sans-serif" size="2"><?php echo smarty_function_math(array('equation' => "x + y",'x' => $this->_tpl_vars['lg_apply_confirmationLSI_jd'],'y' => $this->_tpl_vars['nl_apply_confirmationLSI_jd']), $this);?>
</font></td>
    <td><font face="Verdana, Arial, Helvetica, sans-serif" size="2"><?php echo $this->_tpl_vars['mr_apply_confirmationLSI']; ?>
</font></td>
    <td><font face="Verdana, Arial, Helvetica, sans-serif" size="2"><?php echo $this->_tpl_vars['mn_apply_confirmationLSI']; ?>
</font></td>
    <td><font face="Verdana, Arial, Helvetica, sans-serif" size="2"><?php echo smarty_function_math(array('equation' => "x + y",'x' => $this->_tpl_vars['mr_apply_confirmationLSI'],'y' => $this->_tpl_vars['mn_apply_confirmationLSI']), $this);?>
</font></td>
    <td><font face="Verdana, Arial, Helvetica, sans-serif" size="2"><?php echo $this->_tpl_vars['sr_apply_confirmationLSI']; ?>
</font></td>
    <td><font face="Verdana, Arial, Helvetica, sans-serif" size="2"><?php echo $this->_tpl_vars['sn_apply_confirmationLSI']; ?>
</font></td>
    <td><font face="Verdana, Arial, Helvetica, sans-serif" size="2"><?php echo smarty_function_math(array('equation' => "x + y",'x' => $this->_tpl_vars['sr_apply_confirmationLSI'],'y' => $this->_tpl_vars['sn_apply_confirmationLSI']), $this);?>
</font></td>
    <td><font face="Verdana, Arial, Helvetica, sans-serif" size="2"><?php echo $this->_tpl_vars['car_apply_confirmationLSI']; ?>
</font></td>
  </tr>
