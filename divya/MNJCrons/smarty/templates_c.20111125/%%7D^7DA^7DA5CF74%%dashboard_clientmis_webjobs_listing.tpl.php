<?php /* Smarty version 2.6.19, created on 2010-04-09 12:27:20
         compiled from ni/nidashboard/dashboard_clientmis_webjobs_listing.tpl */ ?>
<html>
<head>
...
<form name="formmain" method = "post" onsubmit = "openNewWindow('dashboard_clientmis_webjobs.php?page=1');return false;" action = "dashboard_clientmis_webjobs.php">
<div id="content">
...
><?php echo $this->_tpl_vars['TO_YEAR_ARR'][$this->_sections['i']['index']]['label']; ?>
    ...
    <TR><TD><input type="button" name="btngo" value="Go" onclick = "openNewWindow('dashboard_clientmis_webjobs.php?action=mis');return false;"> </TD><TD>&nbsp;</TD> </TR>
  </table>
</div>
<br />
<br />
