<?php /* Smarty version 2.6.19, created on 2010-01-18 15:13:49
...
?>
      <?php echo '<tr><td><b><font face="Verdana, Arial, Helvetica, sans-serif" size="2"><center>'; ?><?php echo $this->_tpl_vars['INFO_ARR'][$this->_sections['mysec']['index']]['datecriteriaval']; ?><?php echo '</center></font></b></td><td><font face="Verdana, Arial, Helvetica, sans-serif" size="2"><center>'; ?><?php if ($this->_tpl_vars['INFO_ARR'][$this->_sections['mysec']['index']]['resnewcv'] != '0'): ?><?php echo '<a href="'; ?><?php echo $this->_tpl_vars['DASHBOARD_PATH']; ?><?php echo '/dashboard_resumeview.php?date='; ?><?php echo $this->_tpl_vars['INFO_ARR'][$this->_sections['mysec']['index']]['preview_date']; ?><?php echo '&src='; ?><?php echo $this->_tpl_vars['src']; ?><?php echo '" target="_blank">'; ?><?php endif; ?><?php echo ' '; ?><?php echo $this->_tpl_vars['INFO_ARR'][$this->_sections['mysec']['index']]['resnewcv']; ?><?php echo '</a></center></font></td><td><font face="Verdana, Arial, Helvetica, sans-serif" size="2"><center>'; ?><?php echo $this->_tpl_vars['INFO_ARR'][$this->_sections['mysec']['index']]['respage1']; ?><?php echo '</center></font></td><td><font face="Verdana, Arial, Helvetica, sans-serif" size="2"><center>'; ?><?php echo $this->_tpl_vars['INFO_ARR'][$this->_sections['mysec']['index']]['respage1attached']; ?><?php echo '</center></font></td><td><font face="Verdana, Arial, Helvetica, sans-serif" size="2"><center>'; ?><?php echo $this->_tpl_vars['INFO_ARR'][$this->_sections['mysec']['index']]['respage1pasted']; ?><?php echo '</center></font></td><td><font face="Verdana, Arial, Helvetica, sans-serif" size="2"><center>'; ?><?php echo $this->_tpl_vars['INFO_ARR'][$this->_sections['mysec']['index']]['respage2']; ?><?php echo '</center>  </font></td><td><font face="Verdana, Arial, Helvetica, sans-serif" size="2"><center>'; ?><?php echo $this->_tpl_vars['INFO_ARR'][$this->_sections['mysec']['index']]['respage2attached']; ?><?php echo '</center></font></td><td><font face="Verdana, Arial, Helvetica, sans-serif" size="2"><center>'; ?><?php echo $this->_tpl_vars['INFO_ARR'][$this->_sections['mysec']['index']]['respage2pasted']; ?><?php echo '</center></font></td><td><font face="Verdana, Arial, Helvetica, sans-serif" size="2"><center>'; ?><?php echo $this->_tpl_vars['INFO_ARR'][$this->_sections['mysec']['index']]['respage3']; ?><?php echo '</center>  </font></td><td><font face="Verdana, Arial, Helvetica, sans-serif" size="2"><center>'; ?><?php echo $this->_tpl_vars['INFO_ARR'][$this->_sections['mysec']['index']]['respage3attached']; ?><?php echo '</center></font></td><td><font face="Verdana, Arial, Helvetica, sans-serif" size="2"><center>'; ?><?php echo $this->_tpl_vars['INFO_ARR'][$this->_sections['mysec']['index']]['respage3pasted']; ?><?php echo '</center></font></td><td><font face="Verdana, Arial, Helvetica, sans-serif" size="2"><center>'; ?><?php echo $this->_tpl_vars['INFO_ARR'][$this->_sections['mysec']['index']]['resmodcv']; ?><?php echo '</center></font></td><td><font face="Verdana, Arial, Helvetica, sans-serif" size="2"><center>'; ?><?php echo $this->_tpl_vars['INFO_ARR'][$this->_sections['mysec']['index']]['resavgnew']; ?><?php echo '</center></font></td><td><font face="Verdana, Arial, Helvetica, sans-serif" size="2"><center>'; ?><?php echo $this->_tpl_vars['INFO_ARR'][$this->_sections['mysec']['index']]['resavgmod']; ?><?php echo '</center></font></td></tr>'; ?>
