<?php /* Smarty version 2.6.19, created on 2009-01-30 15:16:48
         compiled from /usr/local/apache/htdocs/smarty/templates/dashboard/dashboard_mobvalidate2.tpl */ ?>
<html>
<head>
...
<tr>
<td width="29%" class="headingtext1"><b>From Date</b></td>
<td class="text">
<select name="day">
...
<tr>
 <td width="29%" class="headingtext1"><b>Total Users with mobile num validated from tele-dialer</b></td>
  <td width="71%" class="text">: <?php echo $this->_tpl_vars['NUMAPPS']; ?>
 </td>
</tr>

<tr>
 <td width="29%" class="headingtext1"><b>Total Users with mobile num validated from resbilling</b></td>
  <td width="71%" class="text">: <?php echo $this->_tpl_vars['NUMRES']; ?>
 </td>
</tr>

<tr>
 <td width="29%" class="headingtext1"><b>Total Users with mobile num validated from resman</b></td>
  <td width="71%" class="text">: <?php echo $this->_tpl_vars['NUMMOBRM']; ?>
 </td>
</tr>

<tr>
 <td width="29%" class="headingtext1"><b>Total Users with mobile num validated from MNJ</b></td>
