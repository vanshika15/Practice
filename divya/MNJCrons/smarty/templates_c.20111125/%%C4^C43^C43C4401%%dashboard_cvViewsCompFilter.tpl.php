<?php /* Smarty version 2.6.19, created on 2011-03-17 13:42:16
         compiled from ni/nidashboard/dashboard_cvViewsCompFilter.tpl */ ?>
<html>
<br />
...
<TR>
<TD class="style1">Select the type of operation</TD>
    <TD>
...
<TR>
<TD class="style1">Enter the company Id</TD>
    <TD>
       <input type="text" name="compid" id="companyId" value="<?php echo $this->_tpl_vars['COMPID']; ?>
"/> 
    </TD>
</TR>
...
<?php if ($this->_tpl_vars['STATUS_MSG']): ?>
<center><font color="green"><h3><?php echo $this->_tpl_vars['STATUS_MSG']; ?>
</h3></font></center>
<?php endif; ?>

<br />
<?php if ($this->_tpl_vars['SUMMARY_ARR'] && $this->_tpl_vars['GO_CLICKED'] == 'go'): ?>
...
<tr>
 <td><b><font face="Verdana, Arial, Helvetica, sans-serif" size="2"><center>Company ID</center></font></b></td>
 <td><b><font face="Verdana, Arial, Helvetica, sans-serif" size="2"><center>Company Name</center></font></b></td>
 <td><b><font face="Verdana, Arial, Helvetica, sans-serif" size="2"><center>Company Id Add Date</center></font></b></td>
</tr>
...
<tr>
   ...
   <td><font face="Verdana, Arial, Helvetica, sans-serif" size="2"><center><?php if ($this->_tpl_vars['data']['cvvfCompName']): ?> <?php echo $this->_tpl_vars['data']['cvvfCompName']; ?>
 <?php else: ?> 0 <?php endif; ?></center></font></td>
   <td><font face="Verdana, Arial, Helvetica, sans-serif" size="2"><center><?php if ($this->_tpl_vars['data']['cvvfAddDate']): ?> <?php echo $this->_tpl_vars['data']['cvvfAddDate']; ?>
 <?php else: ?> 0 <?php endif; ?></center></font></td>
</tr>
