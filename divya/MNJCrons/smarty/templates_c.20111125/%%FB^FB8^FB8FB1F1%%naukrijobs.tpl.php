<?php /* Smarty version 2.6.19, created on 2009-09-18 12:28:24
         compiled from /usr/local/apache/htdocs/fbapps/tpl/naukrijobs.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'truncate', '/usr/local/apache/htdocs/fbapps/tpl/naukrijobs.tpl', 301, false),array('modifier', 'count', '/usr/local/apache/htdocs/fbapps/tpl/naukrijobs.tpl', 313, false),)), $this); ?>
<style type="text/css">
...
.cls{clear: both}
.topbg{ background:#fff url(http://lfvscp10067.dn.net/fbapps/fbui1/nksprite1.png) 0 0 repeat-x; float: left; width:740px;}
...
.fright{ float: right}
.inputSub{ height: 20px; width:67px; border: 0px; color:#000; cursor: pointer;font: bold 11px "lucida grande", tahoma, verdana, arial, sans-serif; text-align:center; background:url(http://lfvscp10067.dn.net/fbapps/fbui1/nksprite1.png) no-repeat 0 -313px; padding-bottom: 3px}
...
<div class="fright"> <img src="http://lfvscp10067.dn.net/fbapps/fbui1/naukriLogo.png" width="241" height="56" alt="Naukri.com" longdesc="http://www.naukri.com" /><br />
 </div>
<div class="spacer1"> </div>
<fb:title>Naukri Job Search</fb:title>
<fb:tabs>  
<fb:tab-item href='http://jobsearch.naukri.com/mynaukri/mn_newsmartsearch.php?xz=2_0_5&id=' title='Job Search' selected='true'/>
<fb:tab-item href='recommend.php' title='Recommendation' />
<fb:tab-item href='http://www.naukri.com/tieups/tieups.php?othersrcp=5424' title='Post Your Resume' />
...
<div class="">
<form name="naukrisearch" method="post" action="">
...
<?php if ($this->_tpl_vars['totalJobs'] == 0): ?>
<!-- Naukri Ad unit start -->
<div align="center"><img src="http://lfvscp10067.dn.net/fbapps/images/fbnkAdunit.png" width="760" height="358" alt="Naukri.com" longdesc="http://www.naukri.com" /></DIV>
<!-- Naukri Ad unit start -->
<?php endif; ?>
<!-- Naukri Ad unit start -->
<div <?php if ($this->_tpl_vars['totalJobs'] == 0): ?>class="dispNone"<?php endif; ?>>
<div class="cl">
<div id="bdrTpPos">
...
?>
<div class="posAbs"><div class="jc" id="080909000601"> <div
class="chkAbs">  </div><div class="jd1">
<div class="fl nkBox">
...
<h2 class="invtFriends">Your Friends into this company</h2>
...
<form name="paginate" method="post" action="">
