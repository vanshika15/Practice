<?php /* Smarty version 2.6.19, created on 2010-12-13 18:15:55
         compiled from ni/nidashboard/dashboard_widget_tracking.tpl */ ?>
<html>
<br />
...
<TR>
<TD class="style1">Select the widget source</TD>
    <TD>
...
<?php if ($this->_tpl_vars['MAIL_TYPE'][0]['selected'] == 'selected'): ?>
<tr>
 <td><b><font face="Verdana, Arial, Helvetica, sans-serif" size="2"><center>Date</center></font></b></td>
 <td><b><font face="Verdana, Arial, Helvetica, sans-serif" size="2"><center>Logged In Searches</center></font></b></td>
 <td><b><font face="Verdana, Arial, Helvetica, sans-serif" size="2"><center>Unique Logged in Searches</center></font></b></td>
 <td><b><font face="Verdana, Arial, Helvetica, sans-serif" size="2"><center>Contact Info Updates</center></font></b></td>
 <td><b><font face="Verdana, Arial, Helvetica, sans-serif" size="2"><center>Years of Exp Updates</center></font></b></td>
 <td><b><font face="Verdana, Arial, Helvetica, sans-serif" size="2"><center>Clicks on Update Current Job link</center></font></b></td>
 <td><b><font face="Verdana, Arial, Helvetica, sans-serif" size="2"><center>Updates from Mini Edit</center></font></b></td>
 <td><b><font face="Verdana, Arial, Helvetica, sans-serif" size="2"><center>Total updates from the widget</center></font></b></td>
</tr>
...
<tr>
   ...
   <td><font face="Verdana, Arial, Helvetica, sans-serif" size="2"><center><?php if ($this->_tpl_vars['data']['srchCount']): ?> <?php echo $this->_tpl_vars['data']['srchCount']; ?>
 <?php else: ?> 0 <?php endif; ?></center></font></td>
   <td><font face="Verdana, Arial, Helvetica, sans-serif" size="2"><center><?php if ($this->_tpl_vars['data']['srchLoggedCount']): ?> <?php echo $this->_tpl_vars['data']['srchLoggedCount']; ?>
 <?php else: ?> 0 <?php endif; ?></center></font></td>

   <td><font face="Verdana, Arial, Helvetica, sans-serif" size="2"><center><?php if ($this->_tpl_vars['data']['dwtCntctInfoUpd']): ?> <?php echo $this->_tpl_vars['data']['dwtCntctInfoUpd']; ?>
 <?php else: ?> 0 <?php endif; ?></center></font></td>
  <td><font face="Verdana, Arial, Helvetica, sans-serif" size="2"><center><?php if ($this->_tpl_vars['data']['dwtYrsOfExpUpd']): ?> <?php echo $this->_tpl_vars['data']['dwtYrsOfExpUpd']; ?>
 <?php else: ?> 0 <?php endif; ?></center></font></td>
  <td><font face="Verdana, Arial, Helvetica, sans-serif" size="2"><center><?php if ($this->_tpl_vars['data']['dwtUpdLnkClick']): ?> <?php echo $this->_tpl_vars['data']['dwtUpdLnkClick']; ?>
 <?php else: ?> 0 <?php endif; ?></center></font></td>

  <td><font face="Verdana, Arial, Helvetica, sans-serif" size="2"><center><?php if ($this->_tpl_vars['data']['dwtUpdFrmWidget']): ?> <?php echo $this->_tpl_vars['data']['dwtUpdFrmWidget']; ?>
 <?php else: ?> 0 <?php endif; ?></center></font></td>
  <td><font face="Verdana, Arial, Helvetica, sans-serif" size="2"><center><?php if ($this->_tpl_vars['data']['totalUpdates']): ?> <?php echo $this->_tpl_vars['data']['totalUpdates']; ?>
 <?php else: ?> 0 <?php endif; ?></center></font></td>
  </tr>
