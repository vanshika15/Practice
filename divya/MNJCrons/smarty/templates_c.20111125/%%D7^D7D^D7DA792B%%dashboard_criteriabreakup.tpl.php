<?php /* Smarty version 2.6.19, created on 2008-06-28 17:12:16
         compiled from ni/nidashboard/dashboard_criteriabreakup.tpl */ ?>
<html>
	<head></head>
...
<form name="criteriabreakup" method="post" action="<?php echo $this->_tpl_vars['FORM_ACTION']; ?>
">
...
><?php echo $this->_tpl_vars['TO_YEAR_ARR'][$this->_sections['i']['index']]['label']; ?>
	...
	<TR align="right">
		<TH>Breakup Criteria</TH>
		<TD>
			<select name="drp_breakup">
				<?php unset($this->_sections['i']);
$this->_sections['i']['name'] = 'i';
$this->_sections['i']['loop'] = is_array($_loop=$this->_tpl_vars['CRITERIA_DRPDOWN']) ? count($_loop) : max(0, (int)$_loop); unset($_loop);
$this->_sections['i']['show'] = true;
$this->_sections['i']['max'] = $this->_sections['i']['loop'];
$this->_sections['i']['step'] = 1;
$this->_sections['i']['start'] = $this->_sections['i']['step'] > 0 ? 0 : $this->_sections['i']['loop']-1;
...
$this->_sections['i']['last']       = ($this->_sections['i']['iteration'] == $this->_sections['i']['total']);
?>
				<option value="<?php echo $this->_tpl_vars['CRITERIA_DRPDOWN'][$this->_sections['i']['index']]['value']; ?>
" <?php echo $this->_tpl_vars['CRITERIA_DRPDOWN'][$this->_sections['i']['index']]['selected']; ?>
><?php echo $this->_tpl_vars['CRITERIA_DRPDOWN'][$this->_sections['i']['index']]['label']; ?>
	...
	<TR align="right">
		<TH>Resume Source</TH>
		<TD>
			<select name="drp_source">
				<?php unset($this->_sections['i']);
$this->_sections['i']['name'] = 'i';
$this->_sections['i']['loop'] = is_array($_loop=$this->_tpl_vars['SOURCE_DRPDOWN']) ? count($_loop) : max(0, (int)$_loop); unset($_loop);
$this->_sections['i']['show'] = true;
$this->_sections['i']['max'] = $this->_sections['i']['loop'];
$this->_sections['i']['step'] = 1;
$this->_sections['i']['start'] = $this->_sections['i']['step'] > 0 ? 0 : $this->_sections['i']['loop']-1;
...
$this->_sections['i']['last']       = ($this->_sections['i']['iteration'] == $this->_sections['i']['total']);
?>
				<option value="<?php echo $this->_tpl_vars['SOURCE_DRPDOWN'][$this->_sections['i']['index']]['value']; ?>
" <?php echo $this->_tpl_vars['SOURCE_DRPDOWN'][$this->_sections['i']['index']]['selected']; ?>
><?php echo $this->_tpl_vars['SOURCE_DRPDOWN'][$this->_sections['i']['index']]['label']; ?>
