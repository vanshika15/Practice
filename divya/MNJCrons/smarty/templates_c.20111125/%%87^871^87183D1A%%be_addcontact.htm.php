<?php /* Smarty version 2.6.19, created on 2011-09-13 12:11:48
         compiled from be_addcontact.htm */ ?>
...
/firstNaukriCrm/css/oadstyle.css" rel="stylesheet" type="text/css" />
    ...
    <body>
        <table width="100%"  border="0" cellspacing="0" cellpadding="0">
            <?php if ($this->_tpl_vars['fromDetails'] != '1'): ?>
            <tr>
            ...
            <tr>
                ...
                <td width="84%" align="left" class="hd">
					Add Contact for <?php echo $this->_tpl_vars['COMPANY_NAME']; ?>
        ...
        <!--form starts-->
        <form name=form1 method=post action="be_addcontact.php" onsubmit="return validate();">

            <table width="80%" border=0 align="center" cellpadding=5 cellspacing=1 class="txt">
                <tr><td colspan=100%>&nbsp;</td></tr>
                <tr bgcolor="#E0ECFF"><th colspan=100%>NEW CONTACT</th></tr>
...
" class="textboxes1" id="phone" size="5" maxlength="40" onBlur="check_phone_ajax()">
            	...
            	<tr align="right"><td colspan="100%"><input type=submit name=add class="txt" value="Add Contact"></td></tr>
         	</table>
...
>
			<input type=hidden name=company_name value='<?php echo $this->_tpl_vars['COMPANY_NAME']; ?>
'>
            <input type=hidden name=fromDetails value=<?php echo $this->_tpl_vars['fromDetails']; ?>
>
     	</form>
        <!--form ends-->
        <br>
